...
import br.com.fiap.concessionaria.dto.response.CaracteristicasResponse;
...
import br.com.fiap.concessionaria.service.CaracteristicasService;
...
public class CaracteristicaResource implements ResourceDTO<Caracteristica, CaracteristicaRequest, CaracteristicasResponse>{
    @Autowired
    private CaracteristicasService service;

    @GetMapping
    public ResponseEntity<Collection<CaracteristicasResponse>> findAll(
        ...
        var veiculo = Veiculo.builder()
                ...
                .build();
        var caracteristica = Caracteristica.builder().nome(nome).descricao(descricao).veiculo(veiculo).build();
    ...
    @GetMapping(value = "/{id}")
    @Override
    public ResponseEntity<CaracteristicasResponse> findById(@PathVariable Long id) {
    ...
    @PostMapping
    @Override
    public ResponseEntity<CaracteristicasResponse> save(@RequestBody @Valid CaracteristicaRequest r) {
